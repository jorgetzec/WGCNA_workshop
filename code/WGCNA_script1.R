...
# Verify the detected root
# message("Root of the project: ", here())

# If necessary, define location with:
# i_am("code/WGCNA_script1.R") 
...
###########-----------------------  3. coldata (PhenoData) Preparation ---------------
...
###########----------------------- 4. Data Preparation: Filtering and Normalization/Transformtion ---------------
# Analyze the filtering options one by one and decide which one should be used.
...
###########-----------------------5. Outlier Detection and Removal (Samples) ---------------
...
###########-----------------------6. Data Properties and Distribution Visualization ---------------
...
###########----------------------- 8. Exploratory Data Analysis (Heatmap) ---------------
...
###########-----------------------  9. WGCNA: Soft Threshold (Power) Definition ---------------
...
bwnet <- blockwiseModules(datExpr,
                          ...
                          # Requires parameters definition
                          )
...
###########-----------------------  11. Module Profile Plots (Example Highlighting a Gene) ---------------
